...
<section class="shop-page-section py-5">
    <div class="container">
                ...
                <?php foreach ($products as $product): ?>
                    <div class="product-card">
                        ...
                        <div class="product-info">
                            <h3 class="product-name" onclick="window.location.href='index.php?page=product_detail&id=<?php echo $product['id']; ?>'">
                                <?php echo $product['name']; ?>
                            </h3>
                            <div class="product-category text-muted small mb-2"><?php echo $product['category']; ?></div>
        ...
        <div class="pagination-container mt-5 d-flex justify-content-center gap-2">
            <?php if ($page > 1): ?>
                <a href="index.php?page=shop&p=<?php echo $page - 1; ?>" class="btn btn-light border">Prev</a>
            <?php endif; ?>

            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                <a href="index.php?page=shop&p=<?php echo $i; ?>" 
                   class="btn <?php echo ($i == $page) ? 'btn-warning text-white' : 'btn-light border'; ?>">
                   <?php echo $i; ?>
                </a>
            <?php endfor; ?>

            <?php if ($page < $totalPages): ?>
                <a href="index.php?page=shop&p=<?php echo $page + 1; ?>" class="btn btn-light border">Next</a>
            <?php endif; ?>
        </div>
        <?php endif; ?>
